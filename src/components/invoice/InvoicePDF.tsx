...
export function InvoicePDF({ invoice }: InvoicePDFProps) {
  ...
  return (
    <Document>
      <Page size="A4" style={{ fontFamily: 'Helvetica', backgroundColor: 'white', paddingBottom: 72 }}>
        ...
        <View style={{
          ...
          <Text style={{ color: brand.headerBg, fontSize: 14, fontFamily: 'Helvetica-Bold', letterSpacing: 2 }}>
        ...
        <View style={{ flexDirection: 'row', justifyContent: 'flex-end', paddingHorizontal: 32, marginTop: 8 }}>
          <View style={{ width: '50%' }}>
            ...
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 8 }}>
              <Text style={{ fontSize: 12, fontFamily: 'Helvetica-Bold', color: brand.headerBg }}>Grand Total</Text>
        ...
        <View style={{
          ...
          <Text style={{ color: 'white', fontSize: 11, fontFamily: 'Helvetica-Bold', letterSpacing: 1.5 }}>
