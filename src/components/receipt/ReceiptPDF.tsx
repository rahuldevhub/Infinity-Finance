...
export default function ReceiptPDF({ receipt, client }: ReceiptPDFProps) {
  ...
  const styles = StyleSheet.create({
    page: { fontFamily: 'Helvetica', backgroundColor: '#ffffff', paddingBottom: 0 },
    ...
    recvLabel: { fontSize: 8, fontFamily: 'Helvetica-Bold', color: '#888888', letterSpacing: 1.5, marginBottom: 6 },
    recvName: { fontSize: 16, fontFamily: 'Helvetica-Bold', color: brand.headerBg, marginBottom: 4 },
    recvWords: { fontSize: 10, color: '#666666', fontFamily: 'Helvetica-Oblique', marginBottom: 8 },
    recvAmount: { fontSize: 22, fontFamily: 'Helvetica-Bold', color: brand.accentColor },
    ...
    cellLabel: { fontSize: 8, fontFamily: 'Helvetica-Bold', color: '#888888', letterSpacing: 0.5, marginBottom: 3 },
    cellValue: { fontSize: 11, fontFamily: 'Helvetica-Bold', color: brand.headerBg },
    ...
    thanksBannerText: { color: '#ffffff', fontSize: 11, fontFamily: 'Helvetica-Bold', letterSpacing: 1.5 },
